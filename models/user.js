 ...
 */
var connection_string = 'mongodb://mlab:mlab@ds259325.mlab.com:59325/67328mlab';
 ...
 */
exports.destroy = function(collection, filter, callback){
  mongoDB.collection(collection).remove(filter, function(err, data){
    if(err){
      doError(err);
    }
    callback(data);
